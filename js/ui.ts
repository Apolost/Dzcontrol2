...
export function initializeDOMElements() {
    DOMElements = {
        ...
        wingsModal: document.getElementById('wings-modal'),
        wingsSettingsModal: document.getElementById('wings-settings-modal'),
        ...
        addMaterialEstimateModal: document.getElementById('add-material-estimate-modal'),
        chickenEstimateModal: document.getElementById('chicken-estimate-modal'),
        ...
        trayStockModal: document.getElementById('tray-stock-modal'),
        trayPalletSettingsModal: document.getElementById('tray-pallet-settings-modal'),
